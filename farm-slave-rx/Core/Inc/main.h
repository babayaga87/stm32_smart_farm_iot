...
#define FLOW_PULSE_Pin GPIO_PIN_0
#define FLOW_PULSE_GPIO_Port GPIOA
#define FLOW_PULSE_EXTI_IRQn EXTI0_IRQn
...
#define PUMP_PIN2_Pin GPIO_PIN_11
#define PUMP_PIN2_GPIO_Port GPIOA
#define PUMP_PIN1_Pin GPIO_PIN_12
#define PUMP_PIN1_GPIO_Port GPIOA
